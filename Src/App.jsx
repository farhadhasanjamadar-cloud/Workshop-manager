...
function FormJob({ data, staff, customers, materialIssues = [], onSave, onCancel, isManager = false, isViewOnly = false, jobCardNumber = "" }) {
      ...
      <Field label="Material name" required><Input value={v.name} onChange={set("name")} /></Field>
        <Field label="Unit">
          <select
            ...
            onChange={(e) => setV(prev => ({ ...prev, unit: e.target.value }))}
          >
...
function Jobs({ items, materials = [], materialIssues = [], onAdd, onEdit, onDelete, onAdvance, onIssueMaterial, isManager = false, isViewOnly = false }) {
  const [q, setQ] = useState("");
