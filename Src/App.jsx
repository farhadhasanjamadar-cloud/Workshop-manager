  ...
  return (
    <div className="app">
      ...
      <Drawer open={!!modal && (!sessionUser || canAccessPage(sessionUser, modal.type))} onClose={closeModal} title={modalTitle(modal, page)}>
        ...
        {modal && modal.type === "jobs" && <FormJob data={modal.data} staff={data.staff} customers={data.customers} onSave={saveJob} onCancel={closeModal} isManager={hasAccessLevel(sessionUser, "Manager")} isViewOnly={(hasAccessLevel(sessionUser, "Team worker") && !hasAccessLevel(sessionUser, "Manager"))} jobCardNumber={jobNumber(data.jobs, modal.data?.id)} />}
