  ...
  return (
    <>
      ...
      <div className="two-col">
        ...
        <Field
          label={isManager ? "Purchase price" : "Total bill amount"}
          hint={isManager ? "Enter the price now. It will be hidden after you save." : ""}
        >
...
function TodayDashboard({ jobs, enquiries, quotations, finance, materials, isManager = false }) {
  ...
  const alerts = [
    ...
    ...(isManager
      ? overdueJobs.map((j) => ({ tone: "warn", text: `${j.customerName}'s order is overdue (due ${fmtDate(j.dueDate)})`, page: "jobs" }))
