...
function FormJob({ data, staff, customers, onSave, onCancel, isManager = false }) {
...
function Jobs({ items, onAdd, onEdit, onDelete, onAdvance, isManager = false }) {
  const [q, setQ] = useState("");
          ...
          return (
            <div className="record-card" key={j.id} onClick={() => onEdit(j)}>
              ...
              <div className="record-sub">
                ...
                {!isManager && bal > 0 && <span className="tone-warn"> · Balance {fmtINR(bal)}</span>}
              </div>
              <div className="record-actions">
                {nextStage && (
    ...
    <div className="app">
      ...
      <main className="main">
        ...
        <div className="content">
          ...
          {page === "jobs" && <Jobs items={data.jobs} onEdit={(r) => openEdit("jobs", r)} onDelete={(id, l) => askDelete("jobs", id, l)} onAdvance={advanceStage} isManager={normalizeAccessLevel(sessionUser?.accessLevel, sessionUser?.role) === "Manager"} />}
      ...
      <Drawer open={!!modal && (!sessionUser || canAccessPage(sessionUser, modal.type))} onClose={closeModal} title={modalTitle(modal, page)}>
        ...
        {modal && modal.type === "jobs" && <FormJob data={modal.data} staff={data.staff} customers={data.customers} onSave={saveJob} onCancel={closeModal} isManager={normalizeAccessLevel(sessionUser?.accessLevel, sessionUser?.role) === "Manager"} />}
