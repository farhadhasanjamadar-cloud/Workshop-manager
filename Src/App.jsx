...
function FormStaff({ data, onSave, onCancel }) {
  const [v, set] = useForm(data || { name: "", role: "", phone: "", email: "", password: "", accessLevel: "Staff", active: true });
  ...
  return (
    <>
      ...
      <Field label="App access level"><Select value={v.accessLevel || "Staff"} onChange={set("accessLevel")} options={ACCESS_LEVELS} /></Field>
