...
function FormMaterial({ data, onSave, onCancel, isManager = false }) {
  ...
  return (
    <>
      ...
      <FormActions
        onCancel={onCancel}
        onSave={() => v.name && onSave(isManager ? { ...v, price: data?.price ?? v.price } : v)}
        disabled={!v.name}
      />
    </>
  );
...
function FormPurchase({ data, materials, onSave, onCancel, isManager = false }) {
  ...
  const isExistingPurchase = !!data?.id;
  return (
    <>
      <Field label="Date"><Input type="date" value={v.date} onChange={set("date")} /></Field>
      ...
      <div className="two-col">
        ...
        {isManager && !isExistingPurchase && (
          <Field label="Purchase price" hint="Enter the price now. It will be hidden after you save.">
            <Input type="number" value={v.totalBill} onChange={set("totalBill")} />
          </Field>
        )}
        {isManager && isExistingPurchase && (
          <div className="field"><div className="field-label">Purchase price</div><div className="row-sub">Hidden</div></div>
        )}
