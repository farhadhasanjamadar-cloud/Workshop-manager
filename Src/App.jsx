...
.drawer{width:min(420px,100%);background:var(--surface);height:100dvh;max-height:100dvh;display:flex;flex-direction:column;border-left:1px solid var(--border);overflow:hidden;}
...
.drawer-body{padding:16px;overflow-y:auto;overflow-x:hidden;flex:1;min-height:0;display:flex;flex-direction:column;gap:14px;-webkit-overflow-scrolling:touch;overscroll-behavior:contain;}
...
@media(max-width:859px){
  ...
  .drawer-body{padding:14px;gap:12px;padding-bottom:max(80px,env(safe-area-inset-bottom));}
