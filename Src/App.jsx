...
function FormJob({ data, staff, customers, onSave, onCancel, isManager = false, isViewOnly = false, jobCardNumber = "" }) {
  ...
  return (
    <div className="app">
      ...
      <Drawer open={!!modal && (!sessionUser || canAccessPage(sessionUser, modal.type))} onClose={closeModal} title={modalTitle(modal, page)}>
        ...
        {modal && modal.type === "jobs" && <FormJob data={modal.data} staff={data.staff} customers={data.customers} onSave={saveJob} onCancel={closeModal} isManager={hasAccessLevel(sessionUser, "Manager")} isViewOnly={(hasAccessLevel(sessionUser, "Manager") || hasAccessLevel(sessionUser, "Team worker"))} jobCardNumber={jobNumber(data.jobs, modal.data?.id)} />}
